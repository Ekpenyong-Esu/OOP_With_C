...
#ifndef STATEMACHINE_SINGLERECEPTOR__TSREVENTQUEUE_H
#define STATEMACHINE_SINGLERECEPTOR__TSREVENTQUEUE_H
...
#endif //STATEMACHINE_SINGLERECEPTOR__TSREVENTQUEUE_H
