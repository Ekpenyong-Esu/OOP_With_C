...
#ifndef STATEMACHINE_SINGLERECEPTOR__TOKENIZEASYNCSINGLEPKG_H
#define STATEMACHINE_SINGLERECEPTOR__TOKENIZEASYNCSINGLEPKG_H
...
#endif //STATEMACHINE_SINGLERECEPTOR__TOKENIZEASYNCSINGLEPKG_H
